...
vendor\phalcon\devtools\phalcon.bat model user --name=user --namespace=Application\Frontend\Entity --output=app/modules/frontend/models/entities --get-set --force
