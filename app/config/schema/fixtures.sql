...
INSERT INTO `user` (`enabled`, `username`, `email`, `password`, `first_name`, `last_name`, `gender`) VALUES (0, 'pcichacki', 'pcichacki@example.com', MD5('password'), 'Piotr', 'Cichacki', 'male');

INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Users', 'Basic system users', '[ ROLE_USER ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Admins', 'System administrators', '[ ROLE_ADMIN ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Superadmins', 'System administrators with extra privileges', '[ ROLE_SUPER_ADMIN ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Basic readers of articles', 'Basic readers of articles', '[ ROLE_BASIC_ARTICLE_READER ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Basic editors of articles', 'Basic editors of articles', '[ ROLE_BASIC_ARTICLE_EDITOR ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Privileged readers of articles ', 'Privileged readers of articles', '[ ROLE_PRIVILEGED_ARTICLE_READER ]');
INSERT INTO `group` (`name`, `description`, `roles`) VALUES ('Privileged editors of articles', 'Privileged editors of articles', '[ ROLE_PRIVILEGED_ARTICLE_EDITOR ]');
